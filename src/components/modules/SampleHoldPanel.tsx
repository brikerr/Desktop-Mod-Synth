...
const SampleHoldPanel: React.FC<SampleHoldPanelProps> = ({ moduleId }) => {
  ...
  return (
    <ModulePanel moduleId={moduleId}>
      <Knob label="Threshold" value={params.threshold} min={0} max={1} step={0.01} onChange={set('threshold')} />
    </ModulePanel>
  );
};

export default SampleHoldPanel;
